...
def _fetch_merge_bodies(
    ...
    Matches commits whose subject starts with ``Merged PR`` — this covers
    both true merge commits and squash-merge commits generated by Azure
    DevOps.  Uses control-character separators (RS=0x1e, US=0x1f) to
    reliably parse multi-line bodies.
    """
    cmd: list[str] = [
        "git", "-C", str(repo_root),
        "log",
